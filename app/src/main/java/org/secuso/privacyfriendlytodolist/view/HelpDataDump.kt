...
class HelpDataDump(private val context: Context) {
    val dataGeneral: LinkedHashMap<String, List<String>>
        get() {
            ...
            expandableListDetail[context.resources.getString(R.string.help_overview_heading)] =
                general
            ...
            expandableListDetail[context.resources.getString(R.string.help_group_privacy)] =
                permissions
